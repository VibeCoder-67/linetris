...
mod tests {
    ...
    use super::{StakeContract, StakeState};
    ...
    fn create_and_instantiate_app(initial_value: u64) -> StakeContract {
        let runtime = ContractRuntime::new().with_application_parameters(());
        let mut contract = StakeContract {
            state: StakeState::load(runtime.root_view_storage_context())
                .blocking_wait()
